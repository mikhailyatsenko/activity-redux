  ...
  return (
    <section className="height100 flex items-center">
      <div className="container mx-auto">
        ...
        <h3 className="text-4xl">{props.currentNameActivity}</h3>

        <h1 className={`text-6xl py-3 align-middle text-purple-500 ${props.currentNameActivity ? null : "text-gray-300"}`}>
        ...
        {props.currentNameActivity ? (
          <button
            disabled={props.currentNameActivity ? false : true}
          ...
          <button
            onClick={props.fetchRandomActivity}
            className="px-4 py-2 bg-purple-500 text-white rounded-md hover:bg-purple-600 focus:outline-none focus:ring-2 focus:ring-purple-300 font-medium disabled:bg-purple-200"
          >
        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full" id="my-modal">
          <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            <div className="mt-3 text-center">
              ...
              <h3 className="text-lg pt-2 leading-6 font-medium text-gray-900">{props.currentNameActivity}</h3>
              <p className="text-sm text-gray-500">
                <strong>
                  {props.startTime} - {props.stopTime}
                </strong>
              </p>
              <form onSubmit={props.saveCommentHandler}>
                <div className="mt-2 px-7 py-3">
                  <textarea
                    rows="3"
                    className="border py-2 w-full px-3"
                    type="text"
                    placeholder="Live a comment about this activity"
                    id="comment"
                    required
                  />
                </div>
