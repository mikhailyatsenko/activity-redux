        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full" id="my-modal">
          <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            <div className="mt-3 text-center">
              ...
              <h3 className="text-lg leading-6 font-medium text-gray-900">Your activity is over!</h3>
              ...
              <form onSubmit={props.saveActivityHandler}>
                <div className="mt-2 px-7 py-3">
                  <input className="border py-2 w-full h-10 px-3" type="text" placeholder="Enter activity name" id="activity" required />
                </div>
